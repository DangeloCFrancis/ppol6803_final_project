...
Surprisingly, our random forests model did not perform well in predicting the political identification of South Korean voters. Despite this, South Korean citizens have recently demonstrated their democratic resilience by successfully thwarting an attempted coup by the sitting president, Yoon Suk Yeol[^10], preventing a regression to authoritarian rule—a resilience rooted in their historical struggles against autocratic leaders. In stark contrast, mainland China has seen an erosion of the few remaining democratic norms. In 2018, President Xi Jinping abolished term limits in 2018's constitutional amendment[^11]. Under Xi, China claims to have the 'broadest, truest, and most effective democracy' through its concept of 'whole-process people's democracy'[^12]. However, in recent years, China has become increasingly repressive as the CCP tightens control over all aspects of life and governance. In 2023, China was ranked as the third least electorally democratic country in the world. This raises a critical question: Do the determinants of political preferences in an entirely different political regime, align with those in democratic countries? 

[^10]: Gan, N. & Bae G.; [A president facing both impeachment and an insurrection probe – what’s next for Yoon Suk Yeol?](https://www.bbc.com/news/articles/c8rjd064012o), 4 December 2024

[^11]: Doubek, J.; [China Removes Presidential Term Limits, Enabling Xi Jinping To Rule Indefinitely](https://www.cnn.com/2024/12/16/asia/south-korea-yoon-what-next-explainer-intl-hnk/index.html), 16 March 2018
