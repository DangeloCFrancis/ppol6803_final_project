...
[^9]: Ng, K., Kwon, J., Ku, Yuna.; [South Korea opposition files motion to impeach President Yoon](https://www.bbc.com/news/articles/c8rjd064012o), 4 December 2024

[^10]: Doubek, J.; [China Removes Presidential Term Limits, Enabling Xi Jinping To Rule Indefinitely](https://www.npr.org/sections/thetwo-way/2018/03/11/592694991/china-removes-presidential-term-limits-enabling-xi-jinping-to-rule-indefinitely), 11 March 2018

[^11]: Chinese People's Daily; [The broadest, truest, and most effective democracy — as guided by General Secretary Xi Jinping in advancing whole-process people's democracy](https://www.gov.cn/xinwen/2023-03/03/content_5744265.htm), 3 March 2023

### Asian Barometer Survey Data 
We use data from the Round 5 Asian Barometer Survey, conducted between 2018 and 2021, just after the constitutional amendment. From the original 306 variables, we select 156 variables that primarily cover information on thermometer ratings and demographics. Most of the dropped variables were excluded due to a high volume of missing data, likely resulting from censorship of speech. Our outcome variable is **q104**: *Where would you place our country [China] today? [Is] democracy suitable or not? [1:10][Democracy is completely unsuitable:Democracy is perfectily suitable]*
