...
anes_2000_2020 <- 
  ...
  select(
    ...
    VCF0607,VCF0608,VCF0609,VCF0610,VCF0611,VCF0612,VCF0613,VCF0614
  ) |>
...
ggplot(data = anes_2000_2020_nab) + 
  geom_miss_point(aes(x = VCF0114, y = VCF0806, color = VCF0114_NA), position = "jitter")
