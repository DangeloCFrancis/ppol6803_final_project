...
# dropping outcome vars, need to fix subset issue

anes_2000_2020_model <- 
  anes_2000_2020 |>
  select(-c(VCF0704,VCF0704a, VCF0705, VCF0706, VCF0301,VCF0906,VCF0907)) |>  # dropping outcome vars
...
# Q: impute before or after split?

anes
impute_median()

anes_recipe <- 
  recipe(formula = VCF0706 ~., roles , data = anes_2000_2020_model)
